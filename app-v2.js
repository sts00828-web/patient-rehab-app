...
function renderToday(){
  ...
  if(S.plans.some(p=>p.from>key))h+='<div class="notice">更新したメニューは明日から始まります。本日の記録はそのまま残ります。</div>';
