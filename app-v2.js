...
function renderToday(){
  ...
  const key=todayKey(),dow=todayDow(),log=getLog(key),items=todayExercises(dow),c=getCompletion(key,dow),before=key<S.startDate,summary=recordSummary(items,log);
